...
| --- | --- | --- |
| ServiceHealthChanged | Cambio confirmado en observabilidad operativa. | eventId, occurredAt, actorId, aggregateId, aggregateType, version, data. |
| AlertTriggered | Cambio confirmado en observabilidad operativa. | eventId, occurredAt, actorId, aggregateId, aggregateType, version, data. |
| IncidentSignalRaised | Cambio confirmado en observabilidad operativa. | eventId, occurredAt, actorId, aggregateId, aggregateType, version, data. |
| MetricThresholdExceeded | Cambio confirmado en observabilidad operativa. | eventId, occurredAt, actorId, aggregateId, aggregateType, version, data. |

## Eventos consumidos

| Evento | Origen esperado | Efecto local |
| --- | --- | --- |
| ScheduleConflictDetected | Servicio propietario del agregado | Actualiza proyeccion local, invalida cache o dispara validacion. |
...
| ServiceHealthChanged | Servicio propietario del agregado | Actualiza proyeccion local, invalida cache o dispara validacion. |
...
~~~json
{
  ...
  "actorId": "uuid",
  "aggregateId": "uuid",
  "aggregateType": "Observabilidad operativa",
  "data": {}
}
~~~
